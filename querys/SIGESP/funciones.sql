...
AS $function$
	BEGIN
		...
		SELECT
        	...
        	UPPER(TRIM(COALESCE(NULLIF(cl.tipperrif, ''), 'V') || COALESCE(NULLIF(cl.numpririf, ''), '00000000')))::varchar AS numpririf,
...
-- DROP FUNCTION public.fn_api_integracion_parametros();

CREATE OR REPLACE FUNCTION public.fn_api_integracion_parametros()
