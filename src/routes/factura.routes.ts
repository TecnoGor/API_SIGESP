...
import * as midd from "../middlewares/factura.middleware.js";
import { verificaToken } from "../middlewares/token.middleware.js";

const router = Router();

router.post("/:id_fact", verificaToken, vali.valPathParamIdFact, midd.valPostBodyFactura, ctrl.postAgregarController);      // ? VERIFICADA - 27-07-2026
